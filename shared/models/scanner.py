...
class FilterParameters(BaseModel):
    ...
    min_dist_from_ema21: Optional[float] = Field(None, description="Min dist from EMA21 (1m) pct")
    max_dist_from_ema21: Optional[float] = Field(None, description="Max dist from EMA21 (1m) pct")
    min_dist_from_ema21_2m: Optional[float] = Field(None, description="Min dist from EMA21 (2m) pct")
    max_dist_from_ema21_2m: Optional[float] = Field(None, description="Max dist from EMA21 (2m) pct")
    min_dist_from_ema21_5m: Optional[float] = Field(None, description="Min dist from EMA21 (5m) pct")
    max_dist_from_ema21_5m: Optional[float] = Field(None, description="Max dist from EMA21 (5m) pct")
    min_dist_from_ema21_15m: Optional[float] = Field(None, description="Min dist from EMA21 (15m) pct")
    max_dist_from_ema21_15m: Optional[float] = Field(None, description="Max dist from EMA21 (15m) pct")
    ...
    # Quote absolute values (bid/ask) + price vs VWAP ratio
    min_bid: Optional[float] = Field(None, description="Min bid price")
    max_bid: Optional[float] = Field(None, description="Max bid price")
    min_ask: Optional[float] = Field(None, description="Min ask price")
    max_ask: Optional[float] = Field(None, description="Max ask price")
    min_price_vs_vwap: Optional[float] = Field(None, description="Min price/VWAP ratio")
    max_price_vs_vwap: Optional[float] = Field(None, description="Max price/VWAP ratio")

    # Index change filters [Spy5..DiaD] — global market context (SPY/QQQ/DIA)
    min_spy_chg_5min: Optional[float] = Field(None, description="Min S&P (SPY) change % last 5 min")
    max_spy_chg_5min: Optional[float] = Field(None, description="Max S&P (SPY) change % last 5 min")
    min_spy_chg_10min: Optional[float] = Field(None, description="Min S&P (SPY) change % last 10 min")
    max_spy_chg_10min: Optional[float] = Field(None, description="Max S&P (SPY) change % last 10 min")
    min_spy_chg_15min: Optional[float] = Field(None, description="Min S&P (SPY) change % last 15 min")
    max_spy_chg_15min: Optional[float] = Field(None, description="Max S&P (SPY) change % last 15 min")
    min_spy_chg_30min: Optional[float] = Field(None, description="Min S&P (SPY) change % last 30 min")
    max_spy_chg_30min: Optional[float] = Field(None, description="Max S&P (SPY) change % last 30 min")
    min_spy_chg_today: Optional[float] = Field(None, description="Min S&P (SPY) change % today")
    max_spy_chg_today: Optional[float] = Field(None, description="Max S&P (SPY) change % today")
    min_qqq_chg_5min: Optional[float] = Field(None, description="Min NASDAQ (QQQ) change % last 5 min")
    max_qqq_chg_5min: Optional[float] = Field(None, description="Max NASDAQ (QQQ) change % last 5 min")
    min_qqq_chg_10min: Optional[float] = Field(None, description="Min NASDAQ (QQQ) change % last 10 min")
    max_qqq_chg_10min: Optional[float] = Field(None, description="Max NASDAQ (QQQ) change % last 10 min")
    min_qqq_chg_15min: Optional[float] = Field(None, description="Min NASDAQ (QQQ) change % last 15 min")
    max_qqq_chg_15min: Optional[float] = Field(None, description="Max NASDAQ (QQQ) change % last 15 min")
    min_qqq_chg_30min: Optional[float] = Field(None, description="Min NASDAQ (QQQ) change % last 30 min")
    max_qqq_chg_30min: Optional[float] = Field(None, description="Max NASDAQ (QQQ) change % last 30 min")
    min_qqq_chg_today: Optional[float] = Field(None, description="Min NASDAQ (QQQ) change % today")
    max_qqq_chg_today: Optional[float] = Field(None, description="Max NASDAQ (QQQ) change % today")
    min_dia_chg_5min: Optional[float] = Field(None, description="Min Dow (DIA) change % last 5 min")
    max_dia_chg_5min: Optional[float] = Field(None, description="Max Dow (DIA) change % last 5 min")
    min_dia_chg_10min: Optional[float] = Field(None, description="Min Dow (DIA) change % last 10 min")
    max_dia_chg_10min: Optional[float] = Field(None, description="Max Dow (DIA) change % last 10 min")
    min_dia_chg_15min: Optional[float] = Field(None, description="Min Dow (DIA) change % last 15 min")
    max_dia_chg_15min: Optional[float] = Field(None, description="Max Dow (DIA) change % last 15 min")
    min_dia_chg_30min: Optional[float] = Field(None, description="Min Dow (DIA) change % last 30 min")
