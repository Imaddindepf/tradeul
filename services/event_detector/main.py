    ...
    async def _build_ticker_state(self, symbol: str, data: Dict) -> Optional[TickerState]:
        ...
        try:
            ...
            return TickerState(
                ...
                vol_1min_pct=enriched.get("vol_1min_pct"),
                vol_5min_pct=enriched.get("vol_5min_pct"),
    ...
    def _evaluate_initial_snapshot_state(
        ...
        def _fire(event_type: EventType, prev_val, new_val, details=None):
            ...
            events.append(EventRecord(
                ...
                vol_1min_pct=current.get("vol_1min_pct"),
                vol_5min_pct=current.get("vol_5min_pct"),
