...
def _aggregate_group(tickers: List[Dict]) -> Dict:
    ...
    return {
        ...
        "avg_change_from_open": r(_safe_avg(_collect(tickers, "change_from_open")), 2),
    ...
    for sym, raw in all_data.items():
        try:
            ...
            tickers.append({
                ...
                "change_from_open": t.get("change_from_open"),
...
async def _get_ticker_context(symbol: str):
    ...
    return {
        ...
        "ticker": {
            ...
            "change_from_open": ticker.get("change_from_open"),
