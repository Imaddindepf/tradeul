...
export const ALERT_CATALOG: AlertDefinition[] = [
  ...
  { code: 'HPMV',  eventType: 'pre_market_volume_spike', name: 'Pre-Market Volume Spike', nameEs: 'Pico Volumen Pre-Market', shortLabel: 'Pre Vol',   category: 'session', direction: 'neutral', active: true, description: 'Pre-market volume far above its historical average', descriptionEs: 'Volumen pre-market muy por encima de su promedio histórico', keywords: ['volume confirmed', 'premarket'], customSetting: cs('volume_ratio', 'Min pre-market RVOL', 'Mín RVOL pre-market', '2.0 = 2x normal pre-market volume. 5.0 = massive.', 'x'), qualityDesc: 'Times more than avg pre-market volume', qualityDescEs: 'Veces más que el volumen pre-market promedio' },
