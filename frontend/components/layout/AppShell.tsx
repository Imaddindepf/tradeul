...
import { AIAlertFiresProvider } from '@/components/floating-window/AIAlertFiresProvider';
import { AIAlertFiresPopup } from '@/components/floating-window/AIAlertFiresPopup';
