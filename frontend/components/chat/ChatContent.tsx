        ...
        <div className="p-1.5 border-b border-border">
          <div className="flex items-center justify-between px-1 mb-1">
            ...
            <button
              ...
              className="p-0.5 rounded hover:bg-muted text-muted-fg hover:text-foreground"
          ...
          {expandedDMs && groups.length > 0 && (
            <div className="space-y-px">
              {groups.map((group) => (
                ...
                >
                  <Users className="w-2.5 h-2.5 shrink-0 text-muted-fg" />
          ...
          {expandedChannels && (
            <div className="space-y-px">
              {channels.map((channel) => (
                ...
                >
                  <Hash className="w-2.5 h-2.5 shrink-0 text-muted-fg" />
          ...
          <div className="h-7 px-2 flex items-center gap-2 border-b border-border bg-muted/30">
            <div className="flex items-center gap-1">
              {isGroup ? (
                ...
                <Hash className="w-3 h-3 text-muted-fg" />
              )}
            ...
            {isGroup && (
              <div className="relative">
                ...
                >
                  <MoreVertical className="w-3.5 h-3.5 text-muted-fg" />
                </button>
