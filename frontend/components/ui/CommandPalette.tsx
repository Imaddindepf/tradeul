...
export function CommandPalette({ open, onOpenChange, onSelectCategory, activeCategories = [], searchValue = '', onSearchChange }: CommandPaletteProps) {
    ...
    const handleSelect = useCallback((value: string) => {
        ...
        if (['dt', 'settings', 'sec', 'news', 'alerts', 'fa', 'ipo', 'profile', 'watchlist', 'chat', 'notes', 'patterns', 'ratio', 'screener', 'mp', 'insider', 'earnings', 'heatmap', 'predict', 'ai', 'ins', 'desc', 'fan', 'hds', 'pulse', 'rtn', 'backtest', 'bt', 'opn', 'api'].includes(value)) {
