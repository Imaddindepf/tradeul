  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="flex items-center justify-between">
            ...
            {session && mounted && (
              <div className="flex items-center gap-4">
                <div className={`px-3 py-1 rounded-full text-sm font-medium ${sessionColors[session.current_session]}`}>
      ...
      <div className="w-full px-0 py-6">
        ...
        <div className="grid grid-cols-12 gap-0 grid-flow-dense" data-grid-root>
          {/* Fila 1: dos columnas */}
        ...
        <GappersTable />
          ...
          <div className="col-span-12 lg:col-span-4">
            {/* Ejemplo reservado para otra tabla futura */}
          </div>
        </div>
      </div>
    </main>
